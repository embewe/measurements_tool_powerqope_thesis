...
def dns_timings(db, xlimit, filename, legend=False, experiments=None):
    quad9_standard_data = {"default_dns": {"timings":[], "color":"#000000", "linestyle":"-"},
            "quad9_standard_dns": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "quad9_standard_doh": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "quad9_standard_dot": {"timings":[], "color":"#0072B2", "linestyle":"-."},
    ...
    cloudflare_standard_data = {"default_dns": {"timings":[], "color":"#000000", "linestyle":"-"},
            "cloudflare_standard_dns": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "cloudflare_standard_doh": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "cloudflare_standard_dot": {"timings":[], "color":"#0072B2", "linestyle":"-."},
    ...
    cleanbrowsing_security_data = {"default_dns": {"timings":[], "color":"#000000", "linestyle":"-"},
            "cleanbrowsing_standard_dns": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_standard_doh": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_standard_dot": {"timings":[], "color":"#0072B2", "linestyle":"-."},
            "cleanbrowsing_adult_dns": {"timings":[], "color":"red", "linestyle":"-"},
            "cleanbrowsing_adult_doh": {"timings":[], "color":"red", "linestyle":":"},
            "cleanbrowsing_adult_dot": {"timings":[], "color":"red", "linestyle":"-."},
            "cleanbrowsing_family_dns": {"timings":[], "color":"purple", "linestyle":"-"},
            "cleanbrowsing_family_doh": {"timings":[], "color":"purple", "linestyle":":"},
            "cleanbrowsing_family_dot": {"timings":[], "color":"purple", "linestyle":"-."}}

    cleanbrowsing_adult_data = {"default_dns": {"timings":[], "color":"#000000", "linestyle":"-"},
            "cleanbrowsing_adult_dns": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_adult_doh": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_adult_dot": {"timings":[], "color":"#0072B2", "linestyle":"-."}}

    cleanbrowsing_family_data = {"default_dns": {"timings":[], "color":"#000000", "linestyle":"-"},
            "cleanbrowsing_family_dns": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_family_doh": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_family_dot": {"timings":[], "color":"#0072B2", "linestyle":"-."}}

    adguard_standard_data = {"default_dns": {"timings":[], "color":"#000000", "linestyle":"-"},
            "adguard_standard_dns": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "adguard_standard_doh": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "adguard_standard_dot": {"timings":[], "color":"#0072B2", "linestyle":"-."}}
    ...
    for tup in timings:
        ...
        if config in quad9_standard_data:
            quad9_standard_data[config]['timings'].append(response_time)
        ...
        if config in cloudflare_standard_data:
            cloudflare_standard_data[config]['timings'].append(response_time)
        ...
        if config in adguard_standard_data:
            adguard_standard_data[config]['timings'].append(response_time)
    ...
    # Plot a CDF
    plot_dns_timings(quad9_standard_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_quad9_standard.pdf", legend=legend)
    ...
    plot_dns_timings(cloudflare_standard_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_cf_standard.pdf", legend=legend)
    ...
    plot_dns_timings(adguard_standard_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_adguard_standard.pdf", legend=legend)
...
def dns_timings_cf(db, xlimit, filename, legend=False, experiments=None):
    ...
    for tup in timings:
        ...
        response_time = tup['response_time']
        response_size = tup['response_size']
        if error or (response_time == 0 and response_time=='nan' and response_size == 0 and error == 0):
            continue
...
def dns_timings_diffs(db, domains, xlimit, filename, configs_subset=None, experiments=None):
    ...
    configs = ( 'default_dns',
                ...
                'cloudflare_standard_dns',
                'cloudflare_standard_dot',
                'cloudflare_standard_doh',
