...
def dns_timings(db, xlimit, filename, legend=False, experiments=None):
    all_recursive_doh_data={
            "default_dns": {"timings":[], "color":"black", "linestyle":"-","marker":"<", "dashes": ()},
            "cloudflare_doh": {"timings":[], "color":"red", "linestyle":"--","marker":".", "dashes": (5, 5)},
            "cloudflare_dot": {"timings":[], "color":"red", "linestyle":"--","marker":"<", "dashes": (5, 1)},
            "google_doh": {"timings":[], "color":"blue", "linestyle":":","marker":"P", "dashes": (3, 5, 1, 5, 1, 5)},
            "google_dot": {"timings":[], "color":"blue", "linestyle":":","marker":">", "dashes": (3, 1, 1, 1, 1, 1)},
            "quad9_dot": {"timings":[], "color":"green", "linestyle":":","marker":">", "dashes": (3, 5, 1, 5)},
            "quad9_doh": {"timings":[], "color":"green", "linestyle":"-.","marker":"^", "dashes": (3, 1, 1, 1)},
