...
from pageload_cdf import dns_pageloads, plot_dns_pageloads
...
def main():
    ...
    parser.add_argument('--pageload_diffs_cleanbrowsing', action='store_true', default=False)
    ...
    if args.pageload_cdf:
        ...
        dns_pageloads(db, domains,xlimit=5, filename=pageload_cdf_filename, legend=True,
                    experiments=args.experiments)
    ...
    if args.pageload_diffs_cf:
        ...
        joint_configs = ('cloudflare_nofilter_dns-cloudflare_family_dns',
                        'cloudflare_nofilter_dns-cloudflare_security_dns',
                        'cloudflare_security_dns-cloudflare_family_dns',
                        'cloudflare_nofilter_dot-cloudflare_family_dot',
                        'cloudflare_nofilter_dot-cloudflare_security_dot',
                        'cloudflare_security_dot-cloudflare_family_dot',
                        'cloudflare_nofilter_doh-cloudflare_family_doh',
                        'cloudflare_nofilter_doh-cloudflare_security_doh',
                        'cloudflare_security_doh-cloudflare_family_doh',
                        'cloudflare_nofilter_dot-cloudflare_family_doh',
                        'cloudflare_nofilter_dot-cloudflare_security_doh',
                        'cloudflare_security_dot-cloudflare_family_doh'
                         )
    ...
    if args.pageload_diffs_quad9:
        ...
        joint_configs = ('quad9_nofilter_dns-quad9_security_dns',
                        'quad9_nofilter_dot-quad9_security_dot',
                        'quad9_nofilter_doh-quad9_security_doh',
                        'quad9_nofilter_dot-quad9_nofilter_doh',
                        'quad9_security_dot-quad9_security_doh'
                         )
        pageload_diffs(db, domains, xlimit=10, filename=pageloads_subset_filename,
                       configs_subset=joint_configs,
                       experiments=args.experiments)
    ...
    if args.pageload_diffs_cleanbrowsing:
        print("Plotting subset of pageload differences for CleanBrowsing")
        joint_configs = ('cleanbrowsing_family_filter_dns-cleanbrowsing_security_filter_dns',
                         'cleanbrowsing_family_filter_dns-cleanbrowsing_adult_filter_dns',
                         'cleanbrowsing_security_filter_dns-cleanbrowsing_adult_filter_doh',
                         ...
                         'cleanbrowsing_family_filter_dot-cleanbrowsing_adult_filter_doh',
                         'cleanbrowsing_family_filter_dot-cleanbrowsing_security_filter_doh',
                         'cleanbrowsing_security_filter_dot-cleanbrowsing_adult_filter_doh'
    ...
    if args.pageload_diffs_adguard_default:
        print("Plotting subset of pageload differences for Adguard")
        joint_configs = ('adguard_nofilter_dns-adguard_family_dns',
                         'adguard_nofilter_dns-adguard_adblock_dns',
                         'adguard_security_dns-adguard_adblock_dns',
                         'adguard_nofilter_doh-adguard_family_doh',
                         'adguard_nofilter_doh-adguard_adblock_doh',
                         'adguard_security_doh-adguard_adblock_doh',
                         'adguard_nofilter_dot-adguard_family_dot',
                         'adguard_nofilter_dot-adguard_adblock_dot',
                         'adguard_security_dot-adguard_adblock_dot'
