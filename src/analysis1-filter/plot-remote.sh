...
python3 plots.py ../../data/database.txt ../../data/domains.txt --matplotlibrc matplotlibrc --pageload_diffs_cleanbrowsing
...
python3 plots.py ../../data/database.txt ../../data/domains.txt --matplotlibrc matplotlibrc --pageload_cdf
