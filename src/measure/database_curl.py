...
class DNSDatabase:
    ...
    def insert_har(self, experiment, domain, cipher, recursive, dns_type, har, har_uuid, har_error, delays,tcptimings,webdelays):
        insert = ''' INSERT INTO {}
        ...
        if har:
            tup = (har_uuid, experiment,vantage_point, now, domain, cipher, recursive,
                   dns_type, Json(har), None, Json(delays),Json(tcptimings),Json(webdelays))
        else:
            tup = (har_uuid, experiment,vantage_point, now, domain, cipher, recursive,
