...
def dns_pageloads(db, domains,xlimit, filename, legend=False, experiments=None):
    quad9_dns = {#"default_dns_Africa": {"pageloads":[], "color":"#000000", "linestyle":"-"},
    ...
    cleanbrowsing_family_data = {
            "cleanbrowsing_family_filter_dot_Africa": {"pageloads":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_family_filter_dot_North America": {"pageloads":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_family_filter_dot_Europe": {"pageloads":[], "color":"#0072B2", "linestyle":"-."},
            "cleanbrowsing_family_filter_doh_Africa": {"pageloads":[], "color":"red", "linestyle":"-"},
            "cleanbrowsing_family_filter_doh_North America": {"pageloads":[], "color":"red", "linestyle":":"},
            "cleanbrowsing_family_filter_doh_Europe": {"pageloads":[], "color":"red", "linestyle":"-."}}
            

    adguard_default_data = {
            "adguard_default_dot_Africa": {"pageloads":[], "color":"#0072B2", "linestyle":"-"},
            "adguard_default_dot_North America": {"pageloads":[], "color":"#0072B2", "linestyle":":"},
            "adguard_default_dot_Europe": {"pageloads":[], "color":"#0072B2", "linestyle":"-."},
            "adguard_default_doh_Africa": {"pageloads":[], "color":"red", "linestyle":"-"},
            "adguard_default_doh_North America": {"pageloads":[], "color":"red", "linestyle":":"},
            "adguard_default_doh_Europe": {"pageloads":[], "color":"red", "linestyle":"-."}}
...
def plot_dns_pageloads(data, xlimit, bin_step, xlabel, filename, legend=False):
    ...
    ax_ins.set_xlim(- margin * 20,
                      20 * (1 + margin))
    ax_ins.set_ylim(-0.05, 1.05)
    ax_ins.set_xticks((0, 20))
