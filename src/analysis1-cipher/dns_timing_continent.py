...
def dns_timings(db, xlimit, filename, legend=False, experiments=None):
    ...
    all_dot_data={
            ...
            "quad9_dot_North America": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "quad9_dot_Europe": {"timings":[], "color":"#0072B2", "linestyle":"-."},
            "cloudflare_dot_Africa": {"timings":[], "color":"red", "linestyle":"-"},
            "cloudflare_dot_North America": {"timings":[], "color":"red", "linestyle":":"},
            "cloudflare_dot_Europe": {"timings":[], "color":"red", "linestyle":"-."},
            "google_dot_Africa": {"timings":[], "color":"green", "linestyle":"-"},
            "google_dot_North America": {"timings":[], "color":"green", "linestyle":":"},
            "google_dot_Europe": {"timings":[], "color":"green", "linestyle":"-."},
           
    }

    all_doh_data={
            "quad9_doh_Africa": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "quad9_doh_North America": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "quad9_doh_Europe": {"timings":[], "color":"#0072B2", "linestyle":"-."},
            "cloudflare_doh_Africa": {"timings":[], "color":"red", "linestyle":"-"},
            "cloudflare_doh_North America": {"timings":[], "color":"red", "linestyle":":"},
            "cloudflare_doh_Europe": {"timings":[], "color":"red", "linestyle":"-."},
            "google_doh_Africa": {"timings":[], "color":"green", "linestyle":"-"},
            "google_doh_North America": {"timings":[], "color":"green", "linestyle":":"},
            
    }

    all_dns_data={
            "quad9_dns_Africa": {"timings":[], "color":"#0072B2", "linestyle":"-"},
            "quad9_dns_North America": {"timings":[], "color":"#0072B2", "linestyle":":"},
            "quad9_dns_Europe": {"timings":[], "color":"#0072B2", "linestyle":"-."},
            "cloudflare_dns_Africa": {"timings":[], "color":"red", "linestyle":"-"},
            "cloudflare_dns_North America": {"timings":[], "color":"red", "linestyle":":"},
            "cloudflare_dns_Europe": {"timings":[], "color":"red", "linestyle":"-."},
            "google_dns_Africa": {"timings":[], "color":"green", "linestyle":"-"},
            "google_dns_North America": {"timings":[], "color":"green", "linestyle":":"},
            "google_dns_Europe": {"timings":[], "color":"green", "linestyle":"-."}
    ...
    for tup in timings:
        ...
        continent=tup['continent']
        error = tup['error']
        config = recursive + "_" + dns_type + "_" + continent
...
def plot_dns_timings(data, xlimit, bin_step, xlabel, filename, legend=False):
    ...
    for key in sorted(data.keys()):
        ...
        ax.plot(sorted_timings, probs, linewidth=1.5, color=color,
                linestyle=linestyle, label=prettify_label(key))
        ax_ins.plot(sorted_timings, probs, linewidth=1.5, color=color,
                    linestyle=linestyle, label=prettify_label(key))
