...
def dns_pings(db, xlimit, filename, legend=False, experiments=None):
    quad9_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "quad9_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "quad9_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "quad9_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    cloudflare_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "cloudflare_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "cloudflare_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "cloudflare_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}
            }

    google_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "google_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "google_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "google_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}
            }
   
    cleanbrowsing_security_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "cleanbrowsing_security_filter_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_security_filter_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_security_filter_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    cleanbrowsing_adult_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "cleanbrowsing_adult_filter_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_adult_filter_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_adult_filter_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    cleanbrowsing_family_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "cleanbrowsing_family_filter_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "cleanbrowsing_family_filter_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "cleanbrowsing_family_filter_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    adguard_default_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "adguard_default_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "adguard_default_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "adguard_default_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    adguard_family_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "adguard_family_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "adguard_family_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "adguard_family_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    securedns_default_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "securedns_default_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "securedns_default_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}

    securedns_adblock_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "securedns_adblock_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "securedns_adblock_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}



    # Get DNS pings for each configuration
    pings = db.get_dns_pings(experiments)
    for tup in pings:
        ...
        if config in quad9_data:
            quad9_data[config]['pings'].append(avg_rtt)
        if config in cloudflare_data:
            cloudflare_data[config]['pings'].append(avg_rtt)
        if config in google_data:
            google_data[config]['pings'].append(avg_rtt)
        if config in cleanbrowsing_security_data:
            cleanbrowsing_security_data[config]['pings'].append(avg_rtt)
        if config in cleanbrowsing_family_data:
            cleanbrowsing_family_data[config]['pings'].append(avg_rtt)
        if config in cleanbrowsing_adult_data:
            cleanbrowsing_adult_data[config]['pings'].append(avg_rtt)
        if config in adguard_default_data:
            adguard_default_data[config]['pings'].append(avg_rtt)
        if config in adguard_family_data:
            adguard_family_data[config]['pings'].append(avg_rtt)
        if config in securedns_default_data:
            securedns_default_data[config]['pings'].append(avg_rtt)
        if config in securedns_adblock_data:
            securedns_adblock_data[config]['pings'].append(avg_rtt)
        

    # Plot a CDF
    plot_dns_pings(quad9_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_quad9.pdf", legend=legend)
    plot_dns_pings(cloudflare_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_cf.pdf", legend=legend)
    plot_dns_pings(google_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_google.pdf", legend=legend)
    plot_dns_pings(cleanbrowsing_security_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_cleanbrowsing_security.pdf", legend=legend)
    plot_dns_pings(cleanbrowsing_family_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_cleanbrowsing_family.pdf", legend=legend)
    plot_dns_pings(cleanbrowsing_adult_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_cleanbrowsing_adult.pdf", legend=legend)
    plot_dns_pings(adguard_default_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_adguard_security.pdf", legend=legend)
    plot_dns_pings(adguard_family_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_adguard_family.pdf", legend=legend)
    plot_dns_pings(securedns_default_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_securedns_security.pdf", legend=legend)
    plot_dns_pings(securedns_adblock_data, xlimit, 1, "DNS Response Time (ms)",
                     filename + "_securedns_adblock.pdf", legend=legend)




def dns_pings_cf(db, xlimit, filename, legend=False, experiments=None):
    cloudflare_data = {"default_dns": {"pings":[], "color":"#000000", "linestyle":"-"},
            "cloudflare_dns": {"pings":[], "color":"#0072B2", "linestyle":"-"},
            "cloudflare_doh": {"pings":[], "color":"#0072B2", "linestyle":":"},
            "cloudflare_dot": {"pings":[], "color":"#0072B2", "linestyle":"-."}}
...
def plot_dns_pings(data, xlimit, bin_step, xlabel, filename, legend=False):
    # Set up the plot
    margin = .033333333
    plt.figure()
    fig, ax = plt.subplots()
    ...
    for key in sorted(data.keys()):
        ...
        print(key, np.mean(pings), np.std(pings))

        color = d["color"]
        linestyle = d["linestyle"]

        # Plot the data
        sorted_pings = np.sort(pings)
        probs = 1. * np.arange(len(sorted_pings))/(len(sorted_pings) - 1)
        ax.plot(sorted_pings, probs, linewidth=2, color=color,
                linestyle=linestyle, label=prettify_label(key))
        ax_ins.plot(sorted_pings, probs, linewidth=1.75, color=color,
                    linestyle=linestyle, label=prettify_label(key))
...
def dns_pings_diffs(db, domains, xlimit, filename, configs_subset=None, experiments=None):
    all_dns_pings = db.get_dns_pings_domains(domains, experiments)
    ...
    configs = ( 'default_dns',
                ...
                'adguard_family_dot',
                'adguard_family_doh',
                'securedns_default_dns',
                'securedns_default_dot',
                'securedns_default_doh',
                'securedns_adblock_dns',
                'securedns_adblock_dot',
                'securedns_adblock_doh'
	          )

    dns_pings_per_experiment = {}
    differences_per_config = {}
    for config in configs:
        for tup in all_dns_pings:
            domain = tup['domain']
            exp = tup['experiment']

            if exp not in dns_pings_per_experiment:
                dns_pings_per_experiment[exp] = {}

            config = tup['recursive'] + '_' + tup['dns_type']
            if config not in dns_pings_per_experiment[exp]:
                dns_pings_per_experiment[exp][config] = {}

            dns_timing = tup['avg_rtt']
            if dns_timing:
                dns_timing = float(dns_timing)
                dns_pings_per_experiment[exp][config][domain] = dns_timing

    for c1 in configs:
        for c2 in configs:
            for exp in dns_pings_per_experiment.keys():
                domains_c1 = dns_pings_per_experiment[exp][c1].keys()
                domains_c2 = dns_pings_per_experiment[exp][c2].keys()
                for domain in (set(domains_c1) & set(domains_c2)):
                    dns_timing_c1 = dns_pings_per_experiment[exp][c1][domain]
                    dns_timing_c2 = dns_pings_per_experiment[exp][c2][domain]
    ...
    if configs_subset:
        plot_dns_pings_diffs_subset(all_data, configs_subset, "Page load time (seconds)",
                                   filename + "_cdf.pdf")
    else:  
        plot_dns_pings_diffs(all_data, configs, (10, 10),
                           "DNS Resolution Time (ms)", filename + "_cdf.pdf")

def plot_dns_pings_diffs_subset(all_data, joint_configs, xlabel, filename, experiments=None):
...
def plot_dns_pings_diffs(all_data, shape, xlabel, filename,experiments,configs=None):
    # Set up the plots
